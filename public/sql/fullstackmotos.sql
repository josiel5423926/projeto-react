...
insert into tb_pedido (nome_cliente, endereco, telefone,  nome_produto, valor_unitario, quantidade,valor_total,idproduto
    )
      values
      ('josiel','rua tal', '56355326','honda',  '45000.00', '1','45000.00','11');

select * from tb_pedido;

TRUNCATE TABLE tb_pedido;  -- comando para deletar todos os registros de uma tabela mysql
